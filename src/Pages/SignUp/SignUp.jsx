...
const SignUp = () => {
    ...
    return (
        <div className="hero min-h-screen bg-base-200 bg-gradient-to-r from-[#fb4a76] to-[#ffb199]">
            ...
            <h1 className="text-3xl text-center font-bold text-white">Sign Up</h1>
             ...
             <div className="form-control">
              ...
              <div className="form-control mt-6">
                <button className="btn text-black font-bold bg-gradient-to-r from-[#ff0844] via-[#ffb199] to-orange-400" type='submit' value="Sign Up">Sign Up</button>
              </div>
              
             </form>
             <p className='my-4 text-center text-white'>Already Have an Account ? : <Link  className="font-black bg-gradient-to-r from-[#ff0844] via-[#ffb199] to-orange-400 bg-clip-text text-transparent" to="/login">Login</Link></p>
            </div>
          </div>
        </div>
      </div>
